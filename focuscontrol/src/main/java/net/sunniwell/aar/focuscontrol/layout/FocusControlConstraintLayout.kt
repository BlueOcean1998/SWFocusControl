...
open class FocusControlConstraintLayout @JvmOverloads constructor(
    ...
    @StyleRes defStyleRes: Int = R.style.FocusControlConstraintLayout
) : ConstraintLayout(context, attrs, defStyleAttr), FocusControlViewParent {
    companion object {
    ...
    init {
        val typedArray = context.obtainStyledAttributes(
            attrs, R.styleable.FocusControlConstraintLayout, 0, defStyleRes
        )
        val recordFocusEnabled = typedArray.getBoolean(
            R.styleable.FocusControlConstraintLayout_recordFocusEnabled, false
        )
        ...
        val searchFocusLeft = typedArray.getResourceId(
            R.styleable.FocusControlConstraintLayout_searchFocusLeft,
            typedArray.getInt(
                R.styleable.FocusControlConstraintLayout_searchFocusLeft, DEF_SEARCH_FOCUS
            )
        )
        val searchFocusRight = typedArray.getResourceId(
            R.styleable.FocusControlConstraintLayout_searchFocusRight,
            typedArray.getInt(
                R.styleable.FocusControlConstraintLayout_searchFocusRight, DEF_SEARCH_FOCUS
            )
        )
        val searchFocusUp = typedArray.getResourceId(
            R.styleable.FocusControlConstraintLayout_searchFocusUp,
            typedArray.getInt(
                R.styleable.FocusControlConstraintLayout_searchFocusUp, DEF_SEARCH_FOCUS
            )
        )
        val searchFocusDown = typedArray.getResourceId(
            R.styleable.FocusControlConstraintLayout_searchFocusDown,
            typedArray.getInt(
                R.styleable.FocusControlConstraintLayout_searchFocusDown, DEF_SEARCH_FOCUS
            )
        )
        typedArray.recycle()
