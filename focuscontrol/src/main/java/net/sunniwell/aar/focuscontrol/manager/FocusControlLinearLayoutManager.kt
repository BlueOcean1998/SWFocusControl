...
/**
 * 焦点控制LinearLayoutManager
 *
 * @author YSK
 * @date 2021-08-06
 */
open class FocusControlLinearLayoutManager : LinearLayoutManager,
    ...
    constructor(
        context: Context,
        @RecyclerView.Orientation orientation: Int, reverseLayout: Boolean = false
